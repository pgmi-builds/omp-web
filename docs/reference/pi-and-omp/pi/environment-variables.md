...
`PI_SERVER_DIR` and `PI_SERVER_ID` apply only to the source-only [experimental remote harness](/docs/latest/development#experimental-remote-harness), not distributed builds.
